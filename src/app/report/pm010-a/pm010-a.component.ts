...
@Component({
  selector: 'app-pm010-a',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm010-a.component.html',
  styleUrl: './pm010-a.component.scss'
})
export class PM010AComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Báo cáo tổng hợp lệnh sửa chữa, BTBD, KĐHC',
        path: 'report/PM010A',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_ORDER_PROCESS/PM010A`, param)
      .subscribe({
        next: (response: any) => {
          if (response != null) {
            HideLoading()
