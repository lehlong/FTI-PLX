...
@Component({
  selector: 'app-pm003-c',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm003-c.component.html',
  styleUrl: './pm003-c.component.scss'
})
export class PM003CComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Kế hoạch và báo cáo kết quả BTBD/KĐHC (Theo kế hoạch)',
        path: 'report/PM003C',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_MPLAN/PM003C`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
