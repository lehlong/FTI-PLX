...
@Component({
  ...
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm017.component.html',
  styleUrl: './pm017.component.scss'
})
export class PM017Component {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Bảng kê vật tư các lệnh sửa chữa, bảo dưỡng, KĐHC',
        path: 'report/PM017',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_ORDER_PROCESS/PM017`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
          if (response != null) {
