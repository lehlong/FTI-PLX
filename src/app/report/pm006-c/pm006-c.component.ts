...
@Component({
  selector: 'app-pm006-c',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm006-c.component.html',
  styleUrl: './pm006-c.component.scss'
})
export class PM006CComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Lệnh bảo dưỡng/KĐHC theo nhóm thiết bị',
        path: 'report/PM006C',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_ORDER_PROCESS/PM006B`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
          if (response != null) {
