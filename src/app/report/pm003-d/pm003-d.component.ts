...
@Component({
  selector: 'app-pm003-d',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm003-d.component.html',
  styleUrl: './pm003-d.component.scss'
})
export class PM003DComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Kế hoạch và báo cáo kết quả BTBD/KĐHC (Theo nhóm thiết bị)',
        path: 'report/PM003D',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_MPLAN/PM003D`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
