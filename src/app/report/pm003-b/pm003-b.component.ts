...
@Component({
  selector: 'app-pm003-b',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm003-b.component.html',
  styleUrl: './pm003-b.component.scss'
})
export class PM003BComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Kết quả BTBD/KĐHC tổng hợp',
        path: 'report/PM003B',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_MPLAN/PM003B`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
