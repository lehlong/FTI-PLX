...
@Component({
  selector: 'app-pm012-a',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm012-a.component.html',
  styleUrl: './pm012-a.component.scss',
})
export class PM012AComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Báo cáo thống kê bảo trì sửa chữa theo khu vực chức năng',
        path: 'report/PM012A',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http
      .post(
        environment.baseApiUrl + `/export_report/ZPG_PM_QM_INFO/PM012A`,
        param,
      )
      .subscribe({
        next: (response: any) => {
