...
@Component({
  selector: 'app-pm006-d',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm006-d.component.html',
  styleUrl: './pm006-d.component.scss'
})
export class PM006DComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Lệnh bảo dưỡng theo nhóm thiết bị (có Tasklist)',
        path: 'report/PM006D',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_ORDER_PROCESS/PM006B2`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
          if (response != null) {
