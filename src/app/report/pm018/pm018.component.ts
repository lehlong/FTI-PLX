...
@Component({
  ...
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm018.component.html',
  styleUrl: './pm018.component.scss',
})
export class PM018Component {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Bảng liệt kê giá trị đo lường của bộ đếm',
        path: 'report/PM018',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http
      .post(
        environment.baseApiUrl + `/export_report/ZPG_EQUI_CORE/PM018A`,
        param,
      )
      .subscribe({
        next: (response: any) => {
