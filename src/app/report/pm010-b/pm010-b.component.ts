...
@Component({
  selector: 'app-pm010-b',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm010-b.component.html',
  styleUrl: './pm010-b.component.scss'
})
export class PM010BComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Báo cáo chi tiết lệnh sửa chữa, BTBD, KĐHC',
        path: 'report/PM010B',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_ORDER_PROCESS/PM010B`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
          if (response != null) {
