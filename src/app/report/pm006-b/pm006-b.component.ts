...
@Component({
  selector: 'app-pm006-b',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm006-b.component.html',
  styleUrl: './pm006-b.component.scss'
})
export class PM006BComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Lệnh bảo dưỡng (Theo nhóm thiết bị)',
        path: 'report/PM006B',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_ORDER_PROCESS/PM006B1`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
          if (response != null) {
