...
@Component({
  selector: 'app-pm009-b',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm009-b.component.html',
  styleUrl: './pm009-b.component.scss'
})
export class PM009BComponent {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Báo cáo chi tiết phiếu sửa chữa',
        path: 'report/PM009B',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_QM_INFO/PM009B`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
          var contentType = "application/vnd.ms-excel";
          var theBlob = Base64ToBlob(response.erawData, contentType);
          SaveBlob(theBlob, "PM009B.xls");
        },
        error: (error) => {
          HideLoading()
