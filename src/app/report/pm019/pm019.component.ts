...
@Component({
  ...
  standalone: true,
  imports: [ShareModule],
  templateUrl: './pm019.component.html',
  styleUrl: './pm019.component.scss'
})
export class PM019Component {
  constructor(
    ...
    this.globalService.setBreadcrumb([
      {
        name: 'Báo cáo tổng hợp kết quả bảo dưỡng',
        path: 'report/PM019',
      },
    ])
  }
  ...
  exportData() {
    ...
    this.http.post(environment.baseApiUrl + `/export_report/ZPG_PM_ORDER_PROCESS/PM019`, param)
      .subscribe({
        next: (response: any) => {
          HideLoading()
          if (response != null) {
